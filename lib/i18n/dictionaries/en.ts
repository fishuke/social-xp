...
const en = {
  ...
  onboarding: {
    ...
    goalTitle: "Which moment makes you freeze?",
    goalSubtitle: "That's exactly what we'll train. You can switch anytime.",
    goals: [
      { id: "interviews", label: "Job interviews" },
      { id: "dating", label: "Dates and first impressions" },
      { id: "speaking-up", label: "Speaking up in a group" },
      { id: "boundaries", label: "Saying no and hard talks" },
      { id: "small-talk", label: "Small talk with new people" },
    ],
  ...
  coach: {
    ...
    liveKicker: "Live scene",
    liveHow1: "Just talk. They hear you and answer out loud.",
    liveHow2: "You can interrupt them mid-sentence. They roll with it.",
    liveHow3: "A few minutes in, the scene ends and you get the read.",
    liveStart: "Start the scene",
    liveConnecting: "Setting the scene…",
    liveTalking: (name: string) => `${name} is talking…`,
    liveYourMove: "Your move 👀",
    liveYourMoveSub: (name: string) => `don't leave ${name} hanging`,
    liveListeningSub: "just talk, then pause. they'll pick it up",
    liveCaptionsTag: (name: string) => `${name}'s voice · live captions`,
    liveYouTag: "you · live",
    vibeDipping: "vibe: dipping 📉",
    vibeWarming: "vibe: warming up",
    vibeWorking: "vibe: it's working ✨",
    statusListening: (name: string) => `${name} is listening`,
    statusLeaning: (name: string) => `${name} is leaning in 👂`,
    statusDrifting: (name: string) => `${name} is drifting… 📉`,
    reactionLaughed: (name: string) => `${name} just laughed 😂`,
    whisperKicker: "Coach · in your ear",
    whisperGotIt: "bet, got it",
    whisperDismiss: "I got this",
    whisperMonologue: "You've been running long 💀 flip it: toss a real question back.",
    whisperAskBack: "Lots of answers, zero questions. Ask one back.",
    whisperShortAnswers: "One-liners kill scenes. Give a detail, then ask back.",
    liveMute: "Mute",
    liveUnmute: "Unmute",
    liveEndScene: "End scene",
    liveWrapUp: "Wrapping up…",
    sceneKicker: (title: string) => `Scene · ${title}`,
    sceneScoring: "Seeing how it went…",
    sceneCta: "See how it went",
    runItBack: "Run it back",
    momentLaughs: (n: number) => `😂 made them laugh ×${n}`,
    momentAskBacks: (n: number) => `👂 asked back ×${n}`,
    momentMonologue: (n: number) =>
      n === 1 ? "💀 one long monologue" : `💀 ${n} long monologues`,
    momentHeld: (time: string) => `⏱️ held the scene for ${time}`,
    debriefKicker: (time: string) => `Live scene · ${time}`,
    rubricTitle: "The read",
    rubricNote: (score: number) => `${score}/5`,
    growthTitle: "Level-up moves",
    conversationTitle: "The conversation",
    youLabel: "You",
    liveChip: "Live",
    salvageTitle: "The line dropped",
    salvageBody: "The connection cut out mid-scene. Score what you got, or run it back later.",
    salvageCta: "Score what we had",
    retryScore: "Try scoring again",
  },
  ...
  errors: {
    ...
    liveUnsupported: "This browser can't do live scenes. Try Chrome or Safari.",
    liveConnectFailed: "Couldn't reach the scene. Check your connection and try again.",
    liveDropped: "The connection dropped mid-scene.",
    liveTooShort: "That scene ended before it got going. Give it at least a couple of replies.",
    liveScoreFailed: "Couldn't score that one. Your conversation is safe, try again.",
    liveRateLimited: "That's a lot of scenes in a row. Take a breather and try again in a bit.",
  },
  notFound: {
    code: "404",
